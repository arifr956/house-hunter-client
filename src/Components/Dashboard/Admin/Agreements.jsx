...
const Agreements = () => {
    ...
    return (
        <div>
      <Helmet>
        <title>House Hunter | Agreements</title>
      </Helmet>
      <SectionTitle heading={`Pending Agreements ${pendingAgreements.length}`} />
      ...
      <div className="flex flex-wrap gap-4">
        {pendingAgreements?.map((a) => (
          <div key={a._id} className="flex flex-col bg-white w-72 h-auto rounded-md p-4 border shadow-md">
            ...
            <h3 className="text-base font-semibold text-gray-900">House Name: {a.name}</h3>
            <p className="text-sm text-gray-500 pb-1">Address: {a.address}</p>
